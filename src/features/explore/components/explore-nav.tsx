      ...
      <div className="flex items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-5">
          <NavbarButton
            ...
            className="w-fit"
          >
            <button className="font-bebas relative inline-flex w-fit items-center gap-1 rounded-lg bg-zinc-950 px-2.5 py-1.5 text-sm font-medium text-white capitalize outline outline-[#fff2f21f] transition-all duration-200 sm:text-[16px]">
