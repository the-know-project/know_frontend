...
export default function GradientText({
  ...
  return (
    <div
      className={`relative flex cursor-pointer flex-row items-center justify-center overflow-hidden rounded-[1.25rem] font-medium transition-shadow duration-500 ${className}`}
    >
      {showBorder && (
        <div
